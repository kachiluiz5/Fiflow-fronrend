                  ...
                  {businessTypes.map(type => (
                    <Label
                      ...
                      className={cn(
                        ...
                        formData.businessType === type.id && "border-primary bg-primary/5"
                      )}
                    >
                  ...
                  {teamSizes.map(size => (
                    <Label
                      ...
                      className={cn(
                        ...
                        formData.teamSize === size.id && "border-primary bg-primary/5"
                      )}
                    >
                ...
                >
                  {useCases.map(useCase => (
                    <Label
                      ...
                      className={cn(
                        "flex items-center justify-center rounded-md border p-4 cursor-pointer hover:border-primary",
                        formData.useCase === useCase.id && "border-primary bg-primary/5"
                      )}
                    >
                ...
                >
                  {industries.map(industry => (
                    <Label
                      ...
                      className={cn(
                        "flex items-center justify-center rounded-md border p-4 cursor-pointer hover:border-primary",
                        formData.industry === industry.id && "border-primary bg-primary/5"
                      )}
                    >
